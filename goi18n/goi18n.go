...
// goi18n does next operations:
//  1. Creates directory "i18n" in <package> and inside it creates so many
//     files as indicated <languages>.
//  2. Reads all files ".go" in <package> and all its subdirectories, extracting
//     string with keys to translate.
//  3. Updates languages files.
//  4. Creates-Updates file "<package>/i18n.go"
// Process of use:
//  1. Run goi18n in the inmediate superior directory of package
//     (e.g.: goi18n myapp en-es)
//  2. Modify languages files translating keys
//  3. Rerun goi18n to update "<package>/i18n.go"
//  4. Recompile package
// Annotation of keys.
//  You have to mark keys to translate using 'I_("key")'.
//  For example: fmt.Println(I_("A message"))
//  The expression 'I_("' must be as is, without inner spaces or tabulations.
// Key syntax.
//  Keys must not include rune '='
// Translation syntax.
//  You have to writen the translation after rune '='
//  Translations must be write like strings inside quotes in code.
//  For example: That is a \"problem\".\nDon't forget it,
//  Translations marked as "ORPHAN" have inexistent keys. If there are no
...
// If a key is not in dictionary, it will appear without modification;
// otherwise it will appear translated.
//
// Example of use:
//  func main() {
//    I18n_lang = I18n_es
...
//  Hola
//  Dia 3, a las 14 p.m.
// 'I_args' allows arguments '0' to '9'. Each argument matches a variable. So
// '0' match the first variable, '1' the second, and so on.
//
// Each argument can apear more than one time.
package main
